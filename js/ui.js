...
const UI = {
  ...
  icon(name, size) {
    ...
    const p = {
      ...
      contract: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h5M8 17h8"/><path d="M14.5 16.8l1.3 1.3 2.7-2.9"/>',
      ...
      creative: '<path d="M9.9 15.5A2 2 0 0 0 8.5 14.1l-5.1-1.3a.5.5 0 0 1 0-1l5.1-1.3A2 2 0 0 0 9.9 9.1l1.3-5.1a.5.5 0 0 1 1 0l1.3 5.1a2 2 0 0 0 1.4 1.4l5.1 1.3a.5.5 0 0 1 0 1l-5.1 1.3a2 2 0 0 0-1.4 1.4l-1.3 5.1a.5.5 0 0 1-1 0z"/><path d="M19 3v3M20.5 4.5h-3M5 17v2M6 18H4"/>',
