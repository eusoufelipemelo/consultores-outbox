...
const TERMOS = {
  ...
  termoServico() {
    ...
    return `
      ...
      <ul>
        <li><b>Condição de liberação:</b> o bônus somente se torna passível de saque quando o Consultor Parceiro atingir o valor mínimo de saque vigente na plataforma, hoje de <b>R$ 500,00</b>, considerando-se o próprio bônus no cômputo desse mínimo, de modo que é necessária a apuração de, ao menos, <b>R$ 400,00 em comissões</b> de vendas efetivamente concretizadas e com pagamento confirmado. As comissões são <b>acumuladas ao longo de todo o prazo</b> abaixo, não se exigindo que o valor seja atingido em um único mês.</li>
