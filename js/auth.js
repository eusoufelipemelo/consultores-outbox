...
const Auth = {
  ...
  aside() {
    ...
    <div>
      <img class="a-logo" src="assets/logo-branca.svg?v=183" alt="OutBox Soluções Digitais"/>
  ...
  viewLogin() {
    ...
    document.getElementById('auth-card').innerHTML = `
      <img class="mob-logo" src="assets/logo-${App.theme === 'dark' ? 'branca' : 'preta'}.svg?v=183"/>
